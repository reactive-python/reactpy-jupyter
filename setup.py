...
class NPM(Command):
    ...
    targets = [
        os.path.join(here, 'idom-jupyter', 'static', 'extension.js'),
        os.path.join(here, 'idom-jupyter', 'static', 'index.js')
    ]
...
version_ns = {}
with open(os.path.join(here, 'idom-jupyter', '_version.py')) as f:
...
setup_args = dict(
    ...
    data_files=[
        ('share/jupyter/nbextensions/idom-client-jupyter', [
            'idom-jupyter/static/extension.js',
            'idom-jupyter/static/index.js',
            'idom-jupyter/static/index.js.map',
        ],),
